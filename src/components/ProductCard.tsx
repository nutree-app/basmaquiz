...
export function ProductCard({
  ...
  return (
    <div className="relative z-10 flex flex-col rounded-[26px] border border-wk-pink/40 bg-ob-card p-6 shadow-[0_0_0_1px_rgba(214,75,120,0.25),0_18px_44px_-22px_rgba(214,75,120,0.7)]">
